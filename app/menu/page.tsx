...
const menuItems = [
    ...
    { name: "Margarita", description: "Classic tomato, mozzarella, and basil.", price: 18.44, category: "Pizza", image: "/menu_images/margherita.webp" },
    ...
    { name: "Soda (Can)", description: "A refreshing soda served in a can.", price: 2.55, category: "Pizza", image: "/menu_images/soda.webp" },
    { name: "Water (small)", description: "Crisp and refreshing small water bottle.", price: 1.99, category: "Pizza", image: "/menu_images/water.webp" },
