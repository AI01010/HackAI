...
const menuItems = [
    ...
    { name: "Customized Pizza", description: "Choose your toppings!", price: 24.06, category: "Pizza", image: "/menu_images/customize.jpg" },
    { name: "Half & Half", description: "Two pizzas in one!", price: 26.08, category: "Pizza", image: "/menu_images/half-hal.jpg" },
    ...
    { name: "Paneer Wrap", description: "", price: 8.29, category: "Pizza", image: "/menu_images/paneer-wi.jpg" },
    ...
    { name: "Red Peppers Bags 3", description: "", price: 0.99, category: "Pizza", image: "/menu_images/red-peppe.jpg" },
    { name: "Parmesan Bags 3", description: "", price: 0.99, category: "Pizza", image: "/menu_images/parmesar.jpg" },
    { name: "Side Olives", description: "", price: 0.99, category: "Pizza", image: "/menu_images/side-olive.jpg" },
    { name: "Side Jalapeno", description: "", price: 0.99, category: "Pizza", image: "/menu_images/side-jalap.jpg" },
    { name: "Side Garlic Mayo", description: "", price: 0.99, category: "Pizza", image: "/menu_images/side-garlic.jpg" },
    { name: "Marinara Sauce", description: "", price: 1.99, category: "Pizza", image: "/menu_images/marinara.jpg" },
